...
export class HelperService {
  ...
  private static mapTableName(tableName: string): string {
    const tableNameMapping: { [key: string]: string } = {
      ...
      // YearOfIssue mappings
      'YearOfIssue': 'year_of_issues',
      'YearOfIssues': 'year_of_issues',
      'yearofissue': 'year_of_issues',
      'yearofissues': 'year_of_issues',
      'year_of_issue': 'year_of_issues',
      'year_of_issues': 'year_of_issues',
      // VehicleYear mappings
      ...
      // YearOfManufacture mappings
      'YearOfManufacture': 'year_of_manufactures',
      'YearOfManufactures': 'year_of_manufactures',
      'yearofmanufacture': 'year_of_manufactures',
      'yearofmanufactures': 'year_of_manufactures',
      'year_of_manufacture': 'year_of_manufactures',
      'year_of_manufactures': 'year_of_manufactures',
